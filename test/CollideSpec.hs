...
spec = do
    ...
    describe "convex hull-convex hull collision" $ do
        ...
        it "test non-collsion" $
            collide notColliding1 notColliding2 `shouldBe` False
        it "test collsion" $
            collide colliding1 colliding2 `shouldBe` True

notColliding1 :: ConvexHull [] V3 Double
notColliding1 = ConvexHull { _vertices = [ V3 (-1.332223) 0.331874 (-1.708829)
...
notColliding2 :: ConvexHull [] V3 Double
notColliding2 = ConvexHull { _vertices = [ V3 (-0.326662) 0.892572 3.641755
...
colliding1 :: ConvexHull [] V3 Double
colliding1 = ConvexHull { _vertices = [ V3 (-1.332223) 0.331874 (-1.708829)
                                      , V3 (-0.149953) (-1.219420) (-2.151234)
                                      , V3 (-0.276591) (-1.855482) (-0.259307)
                                      , V3 (-1.458862) (-0.304188) 0.183098
                                      , V3 0.275943 1.422246 (-1.234603)
...
colliding2 :: ConvexHull [] V3 Double
colliding2 = ConvexHull { _vertices = [ V3 (-0.124179) 0.445695 2.3666065
